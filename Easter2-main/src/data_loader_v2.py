...
class data_loader:
    def __init__(self, path, batch_size):
        ...
        for f in os.listdir(path+"/Dysgraphic1"):
            self.samples.append(Sample(1, path+"/Dysgraphic1/"+f))
            
        for f in os.listdir(path+"/No_Dysgraphic1"):
            self.samples.append(Sample(0, path+"/No_Dysgraphic1/"+f))
        
        for f in os.listdir(path+"/Dysgraphic2"):
            self.samples.append(Sample(1, path+"/Dysgraphic2/"+f))
            
        for f in os.listdir(path+"/No_Dysgraphic2"):
            self.samples.append(Sample(0, path+"/No_Dysgraphic2/"+f))
